...
export const metadata: Metadata = {
	title: 'Jason Choi - Frontend Developer',
	description:
	...
	authors: [{ name: 'Jason Choi' }],
	creator: 'Jason Choi',
	openGraph: {
		title: 'Jason Choi - Frontend Developer Portfolio',
		...
		siteName: 'Jason Choi - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Jason Choi - Frontend Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
