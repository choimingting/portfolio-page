...
const emailLink = 'mailto:choimingting@gmail.com';

const githubLink = 'https://github.com/choimingting';
const linkedInLink = 'https://www.linkedin.com/in/jason-choi-214a8a1b4/';
